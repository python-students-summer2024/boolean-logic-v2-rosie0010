...
def is_sweltering():
    ...
    current_temp = int(input("What is the current temperature in Farenheit? "))
    if current_temp > 90:
        return True
    else:
        return False
...
def is_warm():
    ...
    # write your code for this function below this line.
    current_temp = int(input("What is the current temperature in Farenheit? "))
    if current_temp >= 75 and current_temp <= 87:
        return True
    else:
        return False 
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    humid = input("Is the weather currently humid? ").lower()
    if humid == "yes":
        return True
    else:
        return False 
...
def is_inclement():
    ...
    weather_forecast = input("What is todays weather forecast? ").lower()
